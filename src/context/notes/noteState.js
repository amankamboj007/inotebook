        ...
        const response = await fetch(`${host}/notes/fetch-all-notes`,
            {
                ...
                headers: {
                    ...
                    "auth-token": 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYyZWY3ZWM3MmYwNDcxYzc5MjFiMWE4MSIsImlhdCI6MTY2MTE5ODgzOSwiZXhwIjoxNjYxMjg1MjM5fQ.D_OKk5KJ0MOokEWXsCQHCLNujAuzPvzgPA3ndAImHSY'
                },
